...
def load_data():
    ...
    with engine.connect() as con:
        con.execute("SELECT setval('customers_id_seq', (SELECT MAX(id) FROM customers));")
        con.execute("SELECT setval('products_id_seq', (SELECT MAX(id) FROM products));")
        con.execute("SELECT setval('invoices_id_seq', (SELECT MAX(id) FROM invoices));")
        con.execute("SELECT setval('line_items_id_seq', (SELECT MAX(id) FROM line_items));")
